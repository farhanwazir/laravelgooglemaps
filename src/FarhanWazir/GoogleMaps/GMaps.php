...
class GMaps
{
    ...
    public $geometry = true;                    // Whether Geometry should be enabled
    ...
    public function get_lat_long_from_address($address, $attempts = 0)
    {
        ...
        $data_location = "https://maps.google.com/maps/api/geocode/json?key=".$this->apiKey."&address=".urlencode(utf8_encode($address))."&sensor=".$this->sensor;
        if ($this->region != "" && strlen($this->region) == 2) {
